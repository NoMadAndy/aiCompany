...
import {
  ...
  Wallet, Beaker, Menu, X, GitBranch
} from 'lucide-react'
    ...
    <>
      ...
      <aside className={cn(
        ...
        <button
          ...
          className="hidden lg:flex items-center justify-center h-12 border-t border-[var(--border)] hover:bg-[var(--bg-hover)] transition-colors"
        >
